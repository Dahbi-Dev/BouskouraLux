                        ...
                        <div class="menu-style-2 furniture-menu menu-hover">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="{{ url('products') }}">Categories</a>
                                        <div class="category-menu-dropdown shop-menu">
                                            <div class="category-dropdown-style category-common2 mb-">
                                                {{-- <h4 class="categories-subtitle"></h4> --}}
                                                <ul>
                                                    <li><a href="shop-grid-2-col.html">Men</a></li>
                                                    <li><a href="shop-grid-3-col.html">Women</a></li>
